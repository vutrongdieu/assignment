<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="dieuvtph03975_assignment_assignment_gd2.Account.OpenAuthProviders" %>
